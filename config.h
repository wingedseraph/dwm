...
static const char *fonts[] = {"JetBrainsMono NF:size=26"};
static const char dmenufont[] = "JetBrainsMono NF:size=26";
...
static const char *screenshot[] = {
    ...
    NULL};
static const char *pickcolor[] = {"xcolor", "--selection", "clipboard", NULL};
...
static const Key keys[] = {
    ...
    // {MODKEY | ShiftMask, XK_e, spawn, {.v = pickcolor}},
